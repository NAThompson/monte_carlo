#ifndef NAIVE_MONTE_CARLO_SINGLE_THREAD
#define NAIVE_MONTE_CARLO_SINGLE_THREAD
#include <vector>
#include <atomic>
#include <future>
...
class naive_monte_carlo_single_thread
{
public:
    naive_monte_carlo_single_thread(const F& f, std::vector<std::pair<Real, Real>> const & bounds, Real error_goal): m_f{f}
    {
    ...
    {
        return std::async(std::launch::async, &naive_monte_carlo_single_thread::m_integrate, this);
    }
